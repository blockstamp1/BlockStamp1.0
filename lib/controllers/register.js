...
const incomingPrivateKey = new bitcore.PrivateKey(chains.incomingPrivateKey())
...
const register = async (hash) => {
  ...
  if (docAddress) {
    ...
    try{
     ...
     console.log("WIF:", incomingPrivateKey.toWIF())
     console.log("Address:", incomingPrivateKey.toAddress())
