...
const outgoingHDPublicKey = new bitcore.HDPublicKey(chains.outgoingHDPublicKey())
/**
...
const register = async (hash) => {
  ...
  if (docAddress) {
    ...
    const paymentAddress = new bitcore.Address(outgoinHDgPublicKey.publicKey, chains.network());
