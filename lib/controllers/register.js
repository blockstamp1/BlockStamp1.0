...
const register = async (hash) => {
  ...
  if (docAddress) {
    ...
    const paymentAddress = incomingHDPrivateKey.derive(randomPath).privateKey.getAddress()
    // const paymentAddress = incomingHDPrivateKey.derive(randomPath).privateKey.toAddress()
    // const paymentAddress = "1PJ7aVDQjeZqueUGyXJvmEhhVRQt42uTIO";              
    ...
    //const paymentAddress = chains.paymentAddress()
