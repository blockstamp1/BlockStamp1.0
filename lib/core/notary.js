...
async function createDocproof (docproof) {
  ...
  console.log("BB0:", docproof.payment_address)
  console.log("BB1:", paymentAddress)
  const checkAddress = paymentAddress.toString(true) // if BCH address, don't use prefix
  console.log("BB11", checkAddress)
  ...
  if (balance >= price.satoshis) {
    ...
    // const changeAddress = outgoingHDPublicKey.publicKey.toAddress()
